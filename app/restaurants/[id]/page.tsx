...
interface RestaurantPageProsps {
  params: {
    id: string;
  };
}
const RestaurantPage = async ({ params: { id } }: RestaurantPageProsps) => {
  ...
  return (
    <div>
      ...
      <div className="relative z-50 mt-[-1.5rem] flex items-center justify-between rounded-tl-3xl rounded-tr-3xl bg-white px-5 py-5 pt-5">
        ...
        <div className="flex items-center gap-[3px] rounded-full bg-foreground bg-white px-[2px] py-[2px] text-white">
